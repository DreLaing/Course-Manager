...
const AdminCourseContent = () => {
    ...
    useEffect(()=>{
        axios.get(`https://adtelligent-course-manager.herokuapp.com/admin/get-course/${courseID}`)
        .then(course => {
            setCourseInfo({
    ...
    const makeUpdate = () =>{
        axios.post(`https://adtelligent-course-manager.herokuapp.com/admin/edit-course/${courseID}`,{
